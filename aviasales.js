...
//база данних
    const citiesApi = 'http://api.travelpayouts.com/data/ru/cities.json',
          citiesApi2 = 'dataBase/cities.json',
          proxy = 'https://cors-anywhere.herokuapp.com/',
          API_KEY = '0826816cda0ae14ae96266bd314bb7bf',
...
let city = [];
    ...
    //const city = ['Москва','Санкт-Петербург','Минск','Караганда','Челябинск',
       //'Керчь','Волгоград','Самара','Днепр','Екатеринбург','Одесса',
        //'Ухань','Шимкент','Нижний Новгород','Калининград','Вроцлав','Ростов-на-Дону'];
...
formSearch.addEventListener('submit', (event) => {
    ...
    if (formData.from && formData.to) {
        ...
        const requestData = `?dapart_date=${formData.when}&origin=${formData.from.code}` + 
        ...
        alert ('Введіть корректну назву міста!');
    }
